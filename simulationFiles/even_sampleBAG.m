...
%
%***********************************************************************
% July 24th, 2013. BAG. Modified simply to handle the transpose form of
% incoming data.

function [Et, Ex] = even_sampleBAG(t, x, Fs);

% Obtain the process related parameters
N = size(x, 1);    % number of signals to be interpolated
M = size(t, 2);    % Number of samples provided
